...
# execuet
    ...
    b = {'lat': 50.09, 'lon': 8.66, 'height': 1200, 'host': False, 'ssl': False, 'user': 'pwmgr/adamwrb:Globus7142001', 'caster': 'system.asgeupos.pl', 'port': 8086, 'mountpoint': '/CBKA_RTCM_3_2', 'V2': False, 'verbose': True, 'headerOutput': False}
    a = ntripArgs
